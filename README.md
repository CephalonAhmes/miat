This library's prupose is to help measuring graphics and figures directly in you python IDLE instead of having to save them, then using programs like ImageJ to measure data on them. 
